...
import { AppBar, Toolbar, IconButton, Grid, Paper, Drawer, Box, Typography, useMediaQuery } from '@mui/material';
import MenuIcon from '@mui/icons-material/Menu';
import { styles } from '../../styles/styles';


const Layout = ({ appBarContent, leftSidebarContent, mainContent, rightSidebarContent, footerContent }) => {
  ...
  return (
    <Box sx={styles.layout.layoutBox.sx}>
      ...
      >
        {/* Top App Bar START */}
        <Grid
          size={styles.layout.headerAppBar.leftSize}>
        </Grid>
        <Grid
          size={styles.layout.headerAppBar.midSize}>
          <Item
            sx={styles.layout.headerAppBar.itemSx}>
            <AppBar
              position={styles.layout.headerAppBar.position} sx={styles.layout.headerAppBar.appBarSx}>
              <Toolbar>
                {isMobile && (
                  <IconButton
                ...
                <Typography
                  variant={styles.layout.headerAppBar.typghyVar}>{appBarContent}</Typography>
              </Toolbar>
            </AppBar>
          </Item>
        </Grid>
        <Grid size={styles.layout.headerAppBar.rightSize}>
        </Grid>
        {/* Top App Bar END */}
        ...
        {isMobile && (
          ...
          sx={styles.layout.mobileView.boxSx}>
            <Grid
              size={styles.layout.mobileView.leftSize}>
              <Item
                sx={styles.layout.mobileView.leftSx}>
                <Drawer
                  anchor={styles.layout.mobileView.drawrAnchor}
                  open={drawerOpen}
                  onClose={() => setDrawerOpen(false)}>
                  <Box width={240} p={2} bgcolor="lightgray" role="presentation">
                    {leftSidebarContent}
                  </Box>
            ...
            <Grid
              size={styles.layout.mobileView.midSize}>
              <Item
                sx={styles.layout.mobileView.midSx}>
                {mainContent}
              </Item>
            </Grid>
            <Grid
              size={styles.layout.mobileView.rightSize}>
              <Item
                sx={styles.layout.mobileView.rightSx}>
                {rightSidebarContent}
              </Item>
            </Grid>
          </Box>
        ...
        {!isMobile && isTablet && (
          ...
          <Box
            ...
            <Grid
              size={styles.layout.tabletView.leftSize}>
              <Item
                sx={styles.layout.tabletView.leftSx}>
                {leftSidebarContent}
              </Item>
            </Grid>

            <Grid
              size={styles.layout.tabletView.midSize}>
              <Item
                sx={styles.layout.tabletView.midSx}>

                {mainContent}
              </Item>
            </Grid>
            <Grid
              size={styles.layout.tabletView.rightSize}>
              <Item
                sx={styles.layout.tabletView.rightSx}>
                {rightSidebarContent}
              </Item>
            </Grid>
          </Box>
        ...
        {!isMobile && !isTablet && isDesktop && (
          ...
          <Box
            ...
            <Grid
              size={styles.layout.desktopView.leftSize}>
              <Item
                sx={styles.layout.desktopView.leftSx}>
                {leftSidebarContent}
              </Item>
            </Grid>

            <Grid
              size={styles.layout.desktopView.midSize}>
              <Item
                sx={styles.layout.desktopView.midSx}>
                {mainContent}
              </Item>
            </Grid>

            <Grid
              size={styles.layout.desktopView.rightSize}>
              <Item
                sx={styles.layout.desktopView.rightSx}>
                {rightSidebarContent}
              </Item>
            </Grid>
        ...
        {(!isMobile && !isTablet && !isDesktop) && (
          ...
          <Box
            ...
            <Grid
              size={styles.layout.largeScreenView.leftSize}>
              <Item
                sx={styles.layout.largeScreenView.leftSx}>
                {leftSidebarContent}
              </Item>
            </Grid>

            <Grid
              size={styles.layout.largeScreenView.midSize}>
              <Item
                sx={styles.layout.largeScreenView.midSx}>
                {mainContent}
              </Item>
            </Grid>

            <Grid
              size={styles.layout.largeScreenView.rightSize}>
              <Item
                sx={styles.layout.largeScreenView.rightSx}>
                {rightSidebarContent}
              </Item>
            </Grid>
        ...
        {/* Footer */}
        <Grid
          size={styles.layout.footer.leftSize}>
        </Grid>
        <Grid
          size={styles.layout.footer.midSize}>
          <Item
            sx={styles.layout.footer.sx}>
            {footerContent}
          </Item>
        </Grid>
        <Grid
          size={styles.layout.footer.rightSize}>
        </Grid>
      </Grid>
    </Box>
  );
